...
Use the **mnx-read** skill to answer the request below from the Mnemex knowledge graph in the current
repository.

Request: $ARGUMENTS

Follow the skill exactly: run the overdue/config-drift check first (warn only, never compact); route
